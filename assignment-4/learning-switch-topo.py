...
class LSTopo(Topo):
    ...
    def __init__(self, cpu=.1, bw=10, delay=None, **params):
        ...
        self.addLink(sA, sB, port1=2, port2=2, **lconfig)
        self.addLink(sB, sC, port1=4, port2=2, **lconfig)
        self.addLink(sC, sD, port1=3, port2=3, **lconfig)
        self.addLink(sB, sE, port1=3, port2=3, **lconfig)

        # Add links between hosts and switches
        self.addLink(sA, h1, port1=1, port2=1, **lconfig)
        self.addLink(sB, h2, port1=1, port2=1, **lconfig)
        self.addLink(sC, h3, port1=1, port2=1, **lconfig)
        self.addLink(sD, h4, port1=1, port2=1, **lconfig)
        self.addLink(sD, h5, port1=2, port2=1, **lconfig)
        self.addLink(sE, h6, port1=2, port2=1, **lconfig)
        self.addLink(sE, h7, port1=1, port2=1, **lconfig)
